...
import com.example.lab07.databinding.ActivityComfirmBinding

class ComfirmActivity : AppCompatActivity() {

    private lateinit var binding : ActivityComfirmBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityComfirmBinding.inflate(layoutInflater)
